          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  autoCorrect="off"
                  spellCheck={false}
                  className={`form-input ${errors.username ? "border-red-400 focus:ring-red-400" : ""}`}
                />
                {errors.username && (
            ...
            <div>
              ...
              <input
                ...
                autoCorrect="off"
                spellCheck={false}
                className={`form-input ${errors.confirm_password ? "border-red-400 focus:ring-red-400" : ""}`}
              />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-teal-600 to-sky-600 px-4 py-2.5 text-sm font-semibold text-white shadow hover:from-teal-500 hover:to-sky-500 disabled:opacity-60 transition-all mt-2"
            >
